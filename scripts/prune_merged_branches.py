...
def run_command(command_list):
    try:
        ...
        result = subprocess.run(command_list, capture_output=True, text=True, check=True)  # nosec B603 # noqa: S603
...
def main():
    ...
    for pr in prs:
        ...
        branch_check = subprocess.run(  # nosec B603 # noqa: S603
        ...
        delete_result = subprocess.run(delete_cmd, capture_output=True, text=True)  # nosec B603 # noqa: S603
