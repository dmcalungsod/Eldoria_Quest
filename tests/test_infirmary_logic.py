...
class TestInfirmaryLogic(unittest.TestCase):
    def test_calculate_heal_cost_zero_missing(self):
        ...
        cost = DatabaseManager.calculate_heal_cost(
            current_hp=100, current_mp=50, max_hp=100, max_mp=50
        )
    ...
    def test_calculate_heal_cost_negative_missing(self):
        ...
        cost = DatabaseManager.calculate_heal_cost(
            current_hp=110, current_mp=60, max_hp=100, max_mp=50
        )
        self.assertEqual(cost, 0)
    ...
    def test_calculate_heal_cost_hp_only(self):
        ...
        cost = DatabaseManager.calculate_heal_cost(
            current_hp=90, current_mp=50, max_hp=100, max_mp=50
        )
    ...
    def test_calculate_heal_cost_mp_only(self):
        ...
        cost = DatabaseManager.calculate_heal_cost(
            current_hp=100, current_mp=40, max_hp=100, max_mp=50
        )
    ...
    def test_calculate_heal_cost_mixed(self):
        ...
        cost = DatabaseManager.calculate_heal_cost(
            current_hp=90, current_mp=40, max_hp=100, max_mp=50
        )
    ...
    def test_calculate_heal_cost_minimum_nonzero(self):
        ...
        cost = DatabaseManager.calculate_heal_cost(
            current_hp=99, current_mp=50, max_hp=100, max_mp=50
        )
