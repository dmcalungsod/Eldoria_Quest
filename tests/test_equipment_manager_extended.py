...
class TestEquipmentManagerExtended(unittest.TestCase):
    ...
    def test_equip_item_success(self):
        player_id = 123
        item = {"id": 101, "item_key": "iron_armor", "item_type": "equipment", "slot": "chest", "rarity": "Common", "count": 1}
        ...
        from game_systems.data import class_data
        class_data.CLASSES["Warrior"] = {"id": 1, "allowed_slots": ["chest"]}
