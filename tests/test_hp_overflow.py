...
class MockDatabaseManager:
    ...
    def update_player_vitals(self, discord_id, hp, mp):
    ...
    def set_player_vitals(self, discord_id, hp, mp):
        self.update_player_vitals(discord_id, hp, mp)

    def clamp_player_vitals(self, discord_id, max_hp, max_mp):
        if discord_id in self.players:
            p = self.players[discord_id]
            p["current_hp"] = min(p["current_hp"], max_hp)
            p["current_mp"] = min(p["current_mp"], max_mp)
