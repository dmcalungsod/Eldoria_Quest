...
import test_auto_adventure_regression_extra
...
def run_adventure_tests():
    ...
    suite.addTests(loader.loadTestsFromModule(test_auto_adventure_regression_extra))
...
def run_codex_tests():
    ...
    print("\n" + "-" * 70)
    print("RUNNING CODEX SYSTEM TESTS (Unit)")
    print("-" * 70)
    loader = unittest.TestLoader()
    suite = loader.loadTestsFromModule(test_codex_unlocks)
    runner = unittest.TextTestRunner(verbosity=2)
    result = runner.run(suite)
    return result.wasSuccessful()
