...
class TestTimeQuakeEvent(unittest.TestCase):
    def setUp(self):
    ...
    def test_threat_reduction_in_ouros(self, mock_locations):
        """Test that the threat reduction multiplier is applied during the event in the Silent City of Ouros."""
        # Setup location
        mock_locations.get.return_value = {"name": "The Silent City of Ouros"}
        self.session.location_id = "silent_city_ouros"
        ...
        context = {
            ...
            "event_type": WorldEventSystem.TIME_QUAKE,
        }
        ...
        self.assertEqual(
            passed_threat_reduction,
            0.8,
            "Threat reduction was not applied correctly in Silent City of Ouros.",
        )

    @patch("game_systems.adventure.adventure_session.LOCATIONS")
    def test_threat_reduction_not_applied_elsewhere(self, mock_locations):
        """Test that the threat reduction is NOT applied outside the Silent City of Ouros."""
        ...
        self.assertEqual(
            passed_threat_reduction,
            1.0,
            "Threat reduction was incorrectly applied outside Silent City of Ouros.",
        )

    @patch("game_systems.adventure.adventure_rewards.LootCalculator")
    def test_loot_bonus_in_ouros(self, mock_loot_calc):
        ...
        # Expected: 1.25 (global) * 2.0 (local Silent City of Ouros) = 2.5
        self.assertAlmostEqual(
            passed_loot_boost,
            2.5,
            places=3,
            msg="Loot boost was not calculated correctly in Silent City of Ouros.",
        )
    ...
    def test_loot_bonus_not_applied_elsewhere(self, mock_loot_calc):
        ...
        self.assertAlmostEqual(
            ...
            1.25,
            places=3,
            msg="Loot boost was incorrectly calculated outside Silent City of Ouros.",
        )
